...
namespace PowellNewUOAImpl{
  ...
  //----------------------------------------------------------------------
  int newuoa_(NewUOATargetFun & target,
              long *n,
              long *npt,
              double *x,
              double *rhobeg,
  ...
  int newuob_(NewUOATargetFun & target,
              long *, long *, double *,
  ...
  int biglag_(long *, long *, double *, double *, double *,
              double *, long *, long *,
              long *, double *, double *, double *, double *,
              double *, double *, double *, double *);
  int bigden_(long *, long *, double *, double *, double *,
              double *, long *, long *, long *, long *,
              double *, double *, double *, double *,
              double *, double *, double *);
  int update_(long *, long *,
              double *, double *, long *, long *, double *,
              double *, long *, double *);
...
namespace BOOM{
  ...
  void PowellMinimizer::minimize(const Vector &x){
    ...
    newuoa_(target,
            ...
            &rho_end,
            &iprint,
            &max_number_of_function_evaulations_,
            w.data());
  ...
  void PowellMinimizer::set_evaluation_limit(long limit){
    if(limit < 0){
      report_error("The maximum number of function evaluations must be "
  ...
  void PowellMinimizer::set_precision(double precision){
    if(precision <= 0){
      report_error("Precision argument must be positive in "
  ...
  void PowellMinimizer::set_initial_stepsize(double stepsize){
    if(stepsize <= 0){
      report_error("Stepsize argument must be positive in "
...
{
    /* Local variables */
    static long id, np, iw, igq, ihq, ixb, ifv, ipq, ivl, ixn, ixo, ixp,
            ...
            double *w)
{
    ...
    long xpt_dim1, xpt_offset, bmat_dim1, bmat_offset, zmat_dim1,
...
int bigden_(long *n, long *npt, double *xopt,
            double *xpt, double *bmat, double *zmat, long *idz,
            long *ndim, long *kopt, long *knew, double *d__,
...
/* Subroutine */ int biglag_(long *n, long *npt, double *xopt,
        double *xpt, double *bmat, double *zmat, long *idz,
        long *ndim, long *knew, double *delta, double *d__,
...
int trsapp_(long *n, long *npt, double *xopt,
...
int update_(long *n, long *npt, double *bmat,
            double *zmat, long *idz, long *ndim, double *vlag,
            double *beta, long *knew, double *w)
{
    /* System generated locals */
